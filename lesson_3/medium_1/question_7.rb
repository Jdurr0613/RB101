...
# The data will be changed by the call to mess_with_demographics. the reassignments
# inside the do block reassign the values inside of the hash that it is called on