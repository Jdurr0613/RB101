...
# begin/end until construct? Note that we're not looking to find the factors 
...
# If number % divisor == 0, then divisor divides number with no remainder

# Bonus 2
# What is the purpose of the second-to-last line (line 8) in the method (the factors
# before the method's end)

# having factors as the last statement in the method definition makes factors the 
